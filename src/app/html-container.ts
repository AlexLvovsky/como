import {
  Component, OnInit, ComponentFactoryResolver, ViewContainerRef, ViewChild, ViewChildren,
  ContentChild, Type, ApplicationRef, Injector, ComponentRef, EmbeddedViewRef
} from '@angular/core';
